...
def get_digit(num, digit): # Only for 16-bit integers (< 65535)
...
def set_cc():
	...
	y1 = get_digit(cc4_val, 2)
	y2 = get_digit(cc4_val, 3)
	y3 = get_digit(cc4_val, 4)
	y4 = get_digit(cc4_val, 1)

	cc4_val = ((y1 << 12) + (y2 << 8) + (y3 << 4) + y4)
